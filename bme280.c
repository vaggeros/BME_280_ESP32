...
{
    bme280_write_data(inst, 0xF2, 0x05); //Controls oversampling of humidity->data oversampling ×16
    bme280_write_data(inst, 0xF5, 0x00); //The “config”register sets therate, filter and interface options of the device 
    bme280_write_data(inst, 0xF4, 0xB7);//Controls oversampling of temperature and pressure data & controls the sensor mode
}
